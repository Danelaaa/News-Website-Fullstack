...
let PostController = class PostController {
    ...
    async getPictures(filename, res) {
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
        ...
        fileFilter: (req, file, cb) => {
            if (!file.originalname.match(/\.(jpg|jpeg|png|gif)$/)) {
                return cb(new common_1.BadRequestException('Only image files (jpg, jpeg, png, gif) are allowed!'), false);
            }
            cb(null, true);
        }
    })),
...
], PostController.prototype, "getPictures", null);
__decorate([
